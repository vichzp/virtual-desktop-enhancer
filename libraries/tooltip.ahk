...
Toast(params:=0) {
	...
	Loop, %monitorN% {
		...
		Gui, %GUIHandleName%:Add, Text, xp+25 yp+22, %message%
		...
		DllCall("ShowWindow", "UInt", GUI_ID_%A_Index%, "Int", 5)
	}
...
closePopups() {
	...
	Loop, %monitorN% {
		...
		DllCall("ShowWindow", "UInt", GUI_ID_%A_Index%, "Int", 0)
